				...
				callback: function (data, target) {
					...
					__.ajax({
						...
						success: function (result) {
							let modal = target.closest('[data-modal-cover]');
							if (modal) modal.setAttribute('data-modal-cover', 'hidden')

							document.getElementById('success-modal').setAttribute('data-modal-cover', 'visible');

							setTimeout(function () {
								document.getElementById('success-modal').setAttribute('data-modal-cover', 'hidden');
							}, 4000);
						},
					});
