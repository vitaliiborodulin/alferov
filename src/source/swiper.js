...
(function (global, factory) {
  ...
  function updateSlidesClasses () {
    ...
    // visible slide
    slides.removeClass(params.slideMyVisibleClass);

    var allnextslide = activeSlide.nextAll(("." + (params.slideClass)));
    
    activeSlide.eq(0).addClass(params.slideMyVisibleClass);
    for(var i = 0;i < params.slidesPerView - 1;i++){
      allnextslide.eq(i).addClass(params.slideMyVisibleClass);
    }
  ...
  var defaults = {
    ...
    slideMyVisibleClass: 'visible-slide',
